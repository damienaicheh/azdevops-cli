...
@click.option('-c', '--configuration-file', help='The path to the config.yml file or set the AZDEV_CONFIG_PATH env variable')
@click.option('-ou', '--organization-url', help='The Azure DevOps organization url or set the AZDEV_ORGANIZATION_URL env variable')
@click.option('-pt', '--pat-token', help='The Azure DevOps PAT Token or set the AZDEV_PAT_TOKEN env variable')
